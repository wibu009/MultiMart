...
internal static class Startup
{
    internal static IServiceCollection AddPoLocalization(this IServiceCollection services, IConfiguration config)
    {
        ...
        if (localizationSettings is { EnableLocalization: true, ResourcesPath: not null })
        {
            ...
            services.AddSingleton<ILocalizationFileLocationProvider, ApplicationPoFileLocationProvider>();
        }
